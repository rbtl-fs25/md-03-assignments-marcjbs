...
5.  What data types are contained in the variables? (Reminder: [https://rbtl-fs24.github.io/website/slides/lec-02-visualisation.html#/types-of-variables](https://ds4owd-001.github.io/website/slides/lec-02-visualisation.html#/types-of-variables){.uri})\
    - discrete variables (whole numbers) for e.g. year\
    - continuous variables for body_mass_g, flipper_length_mm, bill_depth_mm, bill_length_mm\
    - categorical variables for species, island and sex
...
- NA values will be ignored using the argument "na.rm" to TRUE in the summarize function.
